            ...
            <div className="max-w-5xl mx-auto my-6">
                ...
                <div className="border-border-primary border mt-4 rounded-lg">
                    <div className="border-b border-border-primary p-2 bg-dark rounded-t-lg flex justify-between items-center">
                        <input className="input input-sm border-border-primary bg-light placeholder:text-text-grey max-w-xs w-full text-xs text-text-secondary" placeholder="Filename including extension..." />
                    </div>
                    <div className="h-80">
                ...
                <div className="mt-3 flex justify-between items-center">
                    ...
                    <div className="flex justify-center items-center relative">
                        <button className=" p-2 rounded-lg border border-r-0 border-border-primary capitalize text-xs bg-button-primary text-white rounded-r-none">{selectedMenu}</button>
