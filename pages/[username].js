            ...
            <div className="grid grid-cols-12 w-full">
                <div className="col-span-3 p-3">
                    ...
                    <div className="my-4">
                        ...
                        <button className="btn btn-sm capitalize w-full mt-4 bg-dark text-text-secondary border-border-primary text-sm hover:bg-dark">View GitHub Profile</button>
                    </div>
                </div>
                <div className="col-span-9 p-3"></div>
            </div>
        </div>
    )
}
